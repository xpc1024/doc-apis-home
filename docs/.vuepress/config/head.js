...
module.exports = [
  ...
  ['meta', { name: 'baidu-site-verification', content: 'codeva-8sufYwJ4ww' }], // 百度站长
  ...
  ['script', {}, `
    ...
    function vote() {
      ...
      voteDetected_div.innerHTML = "<a style='color:#fff;text-decoration:underline' target='_blank' href='xxxxxx'>doc-apis 正在参与“2022年度 OSC 中国开源项目”评选，请为我们投上宝贵的一票，谢谢！</a>";
